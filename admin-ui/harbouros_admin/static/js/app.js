...
function libraryIcon(type) {
    var icons = {
        movie: '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#2563eb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="7" x2="7" y2="7"/><line x1="2" y1="17" x2="7" y2="17"/><line x1="17" y1="7" x2="22" y2="7"/><line x1="17" y1="17" x2="22" y2="17"/></svg>',
        show: '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#2563eb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="15" rx="2" ry="2"/><polyline points="17 2 12 7 7 2"/></svg>',
    ...
    if (wSessions) {
        ...
        if (sessions.length === 0) {
            ...
            wSessions.innerHTML = sessions.map(function(s) {
                ...
                return '<div style="padding:0.3rem 0;border-top:1px solid var(--border)">' +
                    '<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:0.5rem">' +
                    '<span class="text-sm" style="flex:1;line-height:1.4">' + esc(s.title) + '</span>' +
                    '<span style="flex-shrink:0">' + badge + '</span>' +
                    '</div>' +
                    '<div class="text-muted text-sm" style="margin-top:0.15rem">' + esc(s.user) + ' \u2022 ' + esc(s.device) + '</div>' +
                    '</div>';
            }).join('');
        }
    }
